...
> **Heirloom note**: This repo is a **static Surge deployment**; the Express/PostgreSQL/Capacitor sections describe the parent template. Runtime “server” behavior is implemented under `src/mockBackend/`. See `ARCHITECTURE.md` for this project.
